    ...
    return Container(
      ...
      child: Row(children: [
        CircleAvatar(
          backgroundColor: AppColors.primary,
          radius: 22,
          child: Icon(Icons.person,size: 30, color: AppColors.tertiary,),
        ),
        SizedBox(width: 12),
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            ...
            SizedBox(height: 8),
            Text("22:40", style: TextStyle(fontWeight: FontWeight.w500, color: Colors.grey)),
          ],
        ),
        Spacer(),
        Text("R\$ 200,00", style:TextStyle(fontSize: 22, color: Colors.green, fontWeight: FontWeight.w700))
      ]),
    );
  }
}
